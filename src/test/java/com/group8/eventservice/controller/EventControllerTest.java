...
@Import({SecurityConfig.class, JwtAuthFilter.class, JwtUtil.class, RestAuthenticationEntryPoint.class,
...
class EventControllerTest {
    ...
    private String tokenFor(String role) {
        return jwtUtil.generateToken(UUID.randomUUID().toString(), role);
    }
    ...
    void createEventSucceedsForOrganizer() throws Exception {
        EventResponse response = new EventResponse(UUID.randomUUID(), "Valid Title", null, UUID.randomUUID(),
